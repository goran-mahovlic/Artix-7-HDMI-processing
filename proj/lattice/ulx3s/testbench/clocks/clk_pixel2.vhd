...
-- Module  Version: 5.7
--/mt/lattice/diamond/3.7_x64/ispfpga/bin/lin64/scuba -w -n clk_pixel2 -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 25.00 -clkibuf LVTTL33D -fclkop 250.00 -fclkop_tol 0.0 -fclkos 125.00 -fclkos_tol 0.0 -phases 0 -fclkos2 25.00 -fclkos2_tol 0.0 -phases2 0 -phase_cntl STATIC -standby -rst -lock -fb_mode 1 -fdc /home/guest/src/fpga/hdmicapture/Artix-7-HDMI-processing/proj/lattice/ulx3s/ext-v20/clkz/clk_pixel2/clk_pixel2.fdc 

-- Thu Jan 24 01:04:40 2019
...
architecture Structure of clk_pixel2 is
    ...
    attribute IO_TYPE of Inst1_IB : label is "LVTTL33D";
...
begin
    ...
    PLLInst_0: EHXPLLL
        ...
        port map (CLKI=>buf_CLKI, CLKFB=>CLKOP_t, PHASESEL1=>scuba_vlo, 
            ...
            PHASESTEP=>scuba_vlo, PHASELOADREG=>scuba_vlo, STDBY=>STDBY, 
            PLLWAKESYNC=>scuba_vlo, RST=>RST, ENCLKOP=>scuba_vlo, 
            ENCLKOS=>scuba_vlo, ENCLKOS2=>scuba_vlo, ENCLKOS3=>scuba_vlo, 
            CLKOP=>CLKOP_t, CLKOS=>CLKOS_t, CLKOS2=>CLKOS2_t, 
            CLKOS3=>open, LOCK=>LOCK, INTLOCK=>open, REFCLK=>REFCLK, 
            CLKINTFB=>open);
