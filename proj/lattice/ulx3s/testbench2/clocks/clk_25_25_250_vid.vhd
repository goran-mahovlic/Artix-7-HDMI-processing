...
-- Module  Version: 5.7
--/usr/local/diamond/3.7_x64/ispfpga/bin/lin64/scuba -w -n clk_25_25_250_vid -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 25.00 -fclkop 25.00 -fclkop_tol 0.0 -fclkos 250.00 -fclkos_tol 0.0 -phases 0 -phase_cntl STATIC -rst -lock -fb_mode 1 -bw HIGH -fdc /fpga/Artix-7-HDMI-processing/proj/lattice/ulx3s/testbench2/clk_diamond/clk_25_25_250_vid/clk_25_25_250_vid.fdc 

-- Sat May 16 12:42:44 2020
...
entity clk_25_25_250_vid is
    port (
        ...
        CLKOS: out  std_logic; 
        LOCK: out  std_logic);
end clk_25_25_250_vid;

architecture Structure of clk_25_25_250_vid is
...
begin
    ...
    PLLInst_0: EHXPLLL
        ...
        CLKOS2_DIV=>  1, CLKOS_DIV=>  2, CLKOP_DIV=>  20, CLKFB_DIV=>  1, 
